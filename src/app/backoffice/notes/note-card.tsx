 ...
 * seluruh kartu adalah tautan ke `/backoffice/notes/[id]`, jadi satu-satunya cara
    ...
    <li className="card flex h-full flex-col">
      ...
      >
        ...
        <div className="mt-4 flex items-center justify-between gap-2 border-t border-line pt-3">
          ...
          <Link href={`/backoffice/notes/${note.id}`} className="btn btn-primary">
            Buka penuh
          </Link>
        </div>
      </Modal>
