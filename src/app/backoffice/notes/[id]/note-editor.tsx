...
import { AssigneePicker } from "@/app/backoffice/tasks/pickers";
import {
  deleteNote,
  saveNote,
  type EventRefInput,
    ...
    <div className="mx-auto max-w-3xl xl:max-w-5xl">
      ...
      <div className="card p-5 sm:p-6">
        ...
        <input
          ...
          className="w-full border-0 bg-transparent p-0 font-display text-2xl leading-tight text-ink outline-none placeholder:text-ink-subtle"
        />
